...
export class GptController {
  ...
  async imageGeneration(@Body() imageGeneration: ImageGenerationDto) {
  ...
  async imageVariation(@Body() imageGeneration: ImageGenerationDto) {
    return await this.gptService.imageVariation(imageGeneration);
  }
}
